...
// Source: github.com/solo-io/go-utils/debugutils (interfaces: PodFinder,LogCollector,ResourceCollector)
...
func (m *MockLogCollector) GetLogRequests(arg0 kuberesource.UnstructuredResources) ([]*common.LogsRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLogRequests", arg0)
	ret0, _ := ret[0].([]*common.LogsRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLogCollector) SaveLogs(arg0 common.StorageClient, arg1 string, arg2 []*common.LogsRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockResourceCollector) SaveResources(arg0 common.StorageClient, arg1 string, arg2 []kuberesource.VersionedResources) error {
	m.ctrl.T.Helper()
