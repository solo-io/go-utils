...
//go:generate mockgen -destination mocks/mock_helm_client.go -package mocks github.com/solo-io/go-utils/helmutils HelmClient
...
//go:generate mockgen -destination mocks/mock_helm_installation.go -package mocks github.com/solo-io/go-utils/helmutils HelmInstallation
...
//go:generate mockgen -destination mocks/mock_helm_uninstallation.go -package mocks github.com/solo-io/go-utils/helmutils HelmUninstallation
...
//go:generate mockgen -destination mocks/mock_helm_release_list.go -package mocks github.com/solo-io/go-utils/helmutils HelmReleaseListRunner
...
func (d *defaultHelmClient) DownloadChart(chartArchiveUri string) (*chart.Chart, error) {
	...
	chartFileReader, err := networkutils.GetResource(chartArchiveUri)
	if err != nil {
		return nil, err
	}
	...
	chartFile, err := ioutil.TempFile("", "helm-chart")
	if err != nil {
		return nil, err
	}
